...
angular.module('conference.services', [])
    .factory('SessionService', function($q) {
        ...
        // An example of how to make this api asynchronous
        // Not necessary when using in-memory data
        // Makes service more flexible and plug-and-play

        // MORE HERE - Supporting getting all sessions or one by id at this point. If you get all back, we have
        // the filtering options for each JSON field or all to pare down the search without making an REST call...
        return {
            findAll: function() {
