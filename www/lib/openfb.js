...
var openFB = (function () {
    ...
    console.log("Logout URL " + logoutRedirectURL);
    console.log("OAUth URL " + oauthRedirectURL);
    console.log("Base URL " + baseURL);

    document.addEventListener("deviceready", function () {
        runningInCordova = true;
        console.log("Cordova? " + runningInCordova);
        ...
        console.log("**** CHANGED!!!!! Logout URL " + logoutRedirectURL);
        console.log("OAUth URL " + oauthRedirectURL);
...
//        logout();
        ...
        console.log("Open FB Login window with URL " + FB_LOGIN_URL + '?client_id=' + fbAppId + '&redirect_uri=' + oauthRedirectURL +
            '&response_type=token&scope=' + scope, '_blank', 'location=no')
